        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
            ...
            >
              ...
              <div className="h-full w-px bg-linear-to-b from-cyan-500 to-transparent"></div>
            </div>
            ...
            >
              ...
              <div className="h-full w-px bg-linear-to-b from-red-500/80 via-red-500/20 to-transparent border-r border-dashed border-red-500/50"></div>
            </div>
            ...
            >
              ...
              <div className="h-full w-px bg-linear-to-b from-amber-500/80 via-amber-500/20 to-transparent border-r border-dashed border-amber-500/50"></div>
            </div>
          </div>
            ...
            {plcData.trackingData &&
              plcData.trackingData.map((isError, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-3 h-14 bg-red-500 rounded-xs z-20 shadow-[0_0_15px_rgba(239,68,68,1),-5px_0_10px_rgba(239,68,68,0.3)]"
